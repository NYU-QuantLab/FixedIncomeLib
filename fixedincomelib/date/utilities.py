...
def add_period(start_date : Date, 
               term : Period, 
...
def move_to_business_day(input_date : Date, business_day_convention : BusinessDayConvention, holiday_convention : HolidayConvention):
...
def make_schedule(
        ...
        payment_holiday_convention: Optional[HolidayConvention]=HolidayConvention('USGS')) -> pd.DataFrame:
    ...
    this_schedule = ql.Schedule(start_date, 
                                end_date, 
                                accrual_period,
    ...
    for s, e in zip(start_dates, end_dates):
        ...
        p = e
        if payment_offset != '':
            p = add_period(e, payment_offset, payment_business_day_convention, payment_holiday_convention)
